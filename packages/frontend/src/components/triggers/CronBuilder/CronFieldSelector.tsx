    ...
    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
      ...
      <div>
        ...
        <input
          ...
          disabled={disabled}
          placeholder="0, *, 0-30"
          className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100 dark:bg-gray-700 disabled:cursor-not-allowed"
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100 dark:bg-gray-700 disabled:cursor-not-allowed"
        />
        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">{t('triggers.cron.dayOfMonthHint')}</p>
      </div>
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">{t('triggers.cron.dayOfWeekHint')}</p>
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100 dark:bg-gray-700 disabled:cursor-not-allowed"
        />
        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">{t('triggers.cron.yearHint')}</p>
      </div>

      {/* Help Text */}
      <div className="col-span-2 md:col-span-3 mt-2">
        <div className="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-500 bg-blue-50 p-3 rounded-md">
