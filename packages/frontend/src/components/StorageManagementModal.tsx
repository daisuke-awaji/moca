...
function StorageItemComponent({
  ...
  return (
    <div
      ...
      className="border border-gray-200 dark:border-gray-700 rounded-lg p-3 hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-800 transition-colors cursor-pointer"
      role="button"
      tabIndex={0}
      onKeyDown={(e) => {
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-4 text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-1">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <button
            ...
            disabled={isDeleting}
            className="p-2 text-gray-400 dark:text-gray-500 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
...
export function StorageManagementModal({ isOpen, onClose }: StorageManagementModalProps) {
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <Tooltip
              ...
              width="480px"
            >
              <button className="w-6 h-6 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-400 dark:text-gray-500 transition-colors">
      ...
      {/* ツールバー */}
      <div className="px-4 md:px-6 py-2.5 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
        <div className="flex flex-wrap items-center gap-1.5">
          <button
            onClick={() => fileInputRef.current?.click()}
            disabled={isUploading}
            className="flex items-center gap-1.5 px-2 py-1.5 text-xs text-gray-600 dark:text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:hover:text-gray-100 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 rounded disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2 py-1.5 text-xs text-gray-600 dark:text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:hover:text-gray-100 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 rounded transition-colors"
          >
        ...
        {isUploading && (
          <div className="mt-3">
            <div className="flex items-center justify-between text-xs sm:text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500 mb-1">
      ...
      <div className="flex divide-x divide-gray-200 flex-1 min-h-0">
        ...
        <div className="hidden md:block md:w-[240px] flex-shrink-0 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <div className="px-3 py-2">
            <div className="text-xs font-semibold text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-2 px-2">
              {t('storage.folders')}
            </div>
            <FolderTree
              tree={folderTree}
        ...
        <div className="flex-1 flex flex-col min-w-0">
          {/* パンくずナビゲーション */}
          <div className="px-4 md:px-6 py-3 border-b border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-900">
            <div className="flex flex-wrap items-center gap-1 text-sm overflow-x-auto">
              <button
                onClick={handleNavigateToRoot}
                className="flex items-center gap-1 px-2 py-1 text-gray-600 dark:text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:hover:text-gray-100 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 rounded transition-colors whitespace-nowrap"
              >
                ...
                return (
                  <div key={segmentPath} className="flex items-center gap-1">
                    ...
                    <button
                      ...
                      className="px-2 py-1 text-gray-600 dark:text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:hover:text-gray-100 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 rounded transition-colors truncate max-w-[120px] sm:max-w-none"
                    >
                      {segment}
                    </button>
                  </div>
              ...
              <>
                {items.length === 0 && !showNewDirectoryInput ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500 mb-2">{t('storage.emptyFolder')}</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">{t('storage.dragAndDropHint')}</p>
                  </div>
                ) : (
                      ...
                      <div className="border border-blue-300 rounded-lg p-3 bg-blue-50">
                        <div className="flex items-center gap-3">
                          ...
                          <input
                            ...
                            className="flex-1 px-2 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                            autoFocus
                          />
                          <button
                          ...
                          <button
                            ...
                            className="flex-shrink-0 p-2 text-gray-400 dark:text-gray-500 hover:text-red-600 hover:bg-red-50 rounded transition-colors"
        ...
        {contextMenu && (
          <div
            ref={contextMenuRef}
            className="fixed bg-white dark:bg-gray-900 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-1 z-50 min-w-[160px]"
            style={{
          ...
          >
            {contextMenu.type === 'file' ? (
              <button
                ...
                className="w-full px-4 py-2 text-sm text-left hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 flex items-center gap-2 transition-colors"
              >
                <Download className="w-4 h-4 text-gray-600 dark:text-gray-400 dark:text-gray-500" />
                <span className="text-gray-900 dark:text-gray-100">{t('storage.download')}</span>
              </button>
            ) : (
              <>
                <button
                  ...
                  className="w-full px-4 py-2 text-sm text-left hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 flex items-center gap-2 transition-colors"
                >
                  <FolderCog className="w-4 h-4 text-gray-600 dark:text-gray-400 dark:text-gray-500" />
                  <span className="text-gray-900 dark:text-gray-100">{t('storage.setAsWorkingDirectory')}</span>
                </button>
                <button
                ...
                >
                  <Download className="w-4 h-4 text-gray-600 dark:text-gray-400 dark:text-gray-500" />
                  <span className="text-gray-900 dark:text-gray-100">{t('storage.downloadFolder')}</span>
                </button>
              </>
            )}
            <button
              ...
              className="w-full px-4 py-2 text-sm text-left hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 flex items-center gap-2 transition-colors"
            >
              <Trash2 className="w-4 h-4 text-gray-600 dark:text-gray-400 dark:text-gray-500" />
              <span className="text-gray-900 dark:text-gray-100">{t('common.delete')}</span>
            </button>
            ...
            >
              {copiedPath === contextMenu.path ? (
                ...
                <>
                  <Copy className="w-4 h-4 text-gray-600 dark:text-gray-400 dark:text-gray-500" />
                  <span className="text-gray-900 dark:text-gray-100">{t('storage.copyPath')}</span>
                </>
              )}
            </button>
          </div>
      ...
      {/* フッター */}
      <div className="border-t border-gray-200 dark:border-gray-700 px-4 md:px-6 py-3 md:py-4 bg-gray-50 dark:bg-gray-800">
        <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-2 sm:gap-0">
          <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">{t('storage.itemCount', { count: items.length })}</p>
          <button
            onClick={onClose}
