      ...
      <div className="max-w-4xl mx-auto p-4 pb-32">
        ...
        {messages.length === 0 && !error && !isLoadingEvents && selectedAgent && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 dark:text-gray-500 max-w-md mx-auto mb-8">
              ...
              <div className="grid grid-cols-3 gap-3 max-w-2xl mx-auto">
                {selectedAgent.scenarios.map((scenario) => (
                  <button
                    ...
                    className="px-4 py-3 text-left text-sm text-gray-700 dark:text-gray-300 dark:text-gray-600 bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 transition-colors"
                  >
